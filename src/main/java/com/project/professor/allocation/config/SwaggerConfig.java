...
import com.project.professor.allocation.ProfessorAllocationKleysonApplication;
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors
						.basePackage(ProfessorAllocationKleysonApplication.class.getPackage().getName()))
